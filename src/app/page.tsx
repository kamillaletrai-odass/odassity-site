      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pt-16 pb-20 sm:pt-24 sm:pb-28">
          <ScrollReveal>
            ...
            <h1 className="mt-8 max-w-4xl font-display text-hero leading-[0.95] tracking-tight text-paper uppercase">
              Read today.
              <br />
          ...
          {teaser1 && (
            <Link
              ...
              className="absolute top-4 right-0 hidden w-48 rounded-xl border border-paper-faint/15 bg-ink/50 p-3 backdrop-blur-md transition-transform hover:-translate-y-1 sm:block"
            >
              {teaser1.cover && (
          ...
          {teaser2 && (
            <Link
              ...
              className="absolute right-8 bottom-0 hidden w-44 translate-y-1/3 rounded-xl border border-paper-faint/15 bg-ink/50 p-3 backdrop-blur-md transition-transform hover:-translate-y-1 lg:block"
            >
              {teaser2.cover && (
